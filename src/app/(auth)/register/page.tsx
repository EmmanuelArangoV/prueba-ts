  ...
  return (
    <div className="w-full">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-sm text-gray-600">Crea tu cuenta cliente</p>
      </div>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        <div className="space-y-4">
          ...
          <div>
            <label className="text-sm font-semibold text-gray-700 block mb-1">Apellido</label>
            <input
              type="text"
              required
              className="appearance-none rounded-lg block w-full px-4 py-2.5 border border-gray-300 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm transition-shadow shadow-sm"
        ...
        <div className="mt-4 text-sm text-center">
          <Link href="/login" className="font-semibold text-red-600 hover:text-red-500 hover:underline transition-colors">
